      ...
      <div className="absolute top-0 left-0 w-full flex flex-wrap justify-between items-center px-4 md:px-8 py-4 md:py-6 z-20">
        ...
        <div className="flex items-center gap-3 mt-2 sm:mt-0">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-white/20 text-white font-semibold text-sm sm:text-base px-4 sm:px-6 py-2 rounded-full shadow-lg backdrop-blur-md transition-all duration-300 hover:bg-white/30 hover:scale-105 hover:shadow-xl"
          >
          ...
          <button
            ...
            className="bg-[#cbe557] text-gray-900 font-semibold text-sm sm:text-base px-4 sm:px-6 py-2 rounded-full shadow-lg transition-all duration-300 hover:bg-[#b8d93e] hover:scale-105 hover:shadow-xl"
          >
            Sign In
          </button>
        </div>
